    ...
    <div className="w-full bg-white text-black font-sans border-2 border-black text-sm print:border-2">
      ...
      <div className="flex border-b-2 border-black">
        ...
        <div className="w-1/2 border-r-2 border-black flex flex-col">
          ...
          <div className="flex border-b border-black">
            <div className="w-1/4 p-1 border-r border-black">Supplier</div>
            <div className="w-3/4 p-1">{invoice.logistics?.receiver?.name || 'Customer'}</div>
          </div>
          <div className="flex border-b border-black">
            <div className="w-1/4 p-1 border-r border-black">GSTIN</div>
        ...
        <div className="w-1/2 flex flex-col">
          ...
          <div className="flex border-b border-black">
            ...
            <div className="w-1/2 p-1 font-bold">{invoice.trackingNumber || 'PENDING'}</div>
          </div>
          <div className="flex border-b border-black">
      ...
      <div className="flex min-h-[150px] border-b-2 border-black text-center">
        ...
        <div className="w-[45%] p-4 border-r border-black text-left space-y-1">
        ...
        <div className="w-[15%] p-2 border-r border-black flex flex-col font-bold justify-center">
          <span>Fix</span>
          <span>vehicle</span>
          <span>LM</span>
        </div>
      ...
      <div className="flex border-b-2 border-black">
        ...
        <div className="w-[15%] p-1 text-right font-bold">
          {Number(baseFreightRate).toLocaleString('en-IN', {minimumFractionDigits: 2})}
        </div>
      </div>
...
export default InfinityInvoiceForm;
