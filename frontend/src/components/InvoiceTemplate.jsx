...
const InvoiceTemplate = ({ data }) => {
  ...
  return (
    <div className="w-full h-full bg-white text-black p-6 relative font-sans print:p-2">
      ...
      <div className="relative z-10">
        ...
        {/* Route Details */}
        <div className="flex justify-between mb-6 bg-gray-50 p-4 border border-gray-300 rounded-lg">
        ...
        <div className="border border-gray-300 rounded-lg p-3 bg-gray-50 mb-6">
          <h3 className="text-xs font-bold text-gray-400 tracking-widest uppercase mb-2 border-b border-gray-200 pb-2">Cargo / Commodity Declaration</h3>
