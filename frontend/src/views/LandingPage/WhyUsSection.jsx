...
const WhyUsSection = () => {
  return (
    <section id="why-us" className="container mx-auto px-4 sm:px-6 py-20 lg:py-24 relative z-10 border-t border-slate-100 scroll-mt-24">
      <div className="max-w-4xl mx-auto text-center mb-12 sm:mb-16">
        ...
        <p className="font-['Inter'] font-normal text-sm sm:text-[16px] leading-relaxed mt-3 sm:mt-4 max-w-2xl mx-auto" style={{ color: 'rgba(0, 0, 0, 0.6)' }}>
        ...
        <p className="text-xs text-slate-400 md:hidden font-medium mt-2">Swipe feature cards horizontally →</p>
      </div>

      {/* Mobile Horizontal Carousel Marquee / Desktop 2-Column Grid */}
      <div className="flex md:grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-8 max-w-6xl mx-auto overflow-x-auto md:overflow-visible snap-x snap-mandatory pb-6 md:pb-0 scrollbar-none -mx-4 px-4 sm:mx-0 sm:px-0">
        {/* Card 1 */}
        <div className="flex-shrink-0 w-[85%] sm:w-[320px] md:w-auto snap-center bg-white border border-slate-200 rounded-2xl p-6 sm:p-8 shadow-sm hover:shadow-md transition-all duration-300">
          <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-blue-50 text-[#187baa] flex items-center justify-center font-bold text-lg sm:text-xl mb-4 sm:mb-6">
            01
          </div>
          <h3 className="font-['Inter'] font-bold text-lg sm:text-xl text-slate-900 mb-2 sm:mb-3">
            Real-Time Telematics & AI Diagnostics
          </h3>
          <p className="font-['Inter'] font-normal text-xs sm:text-sm text-slate-600 leading-relaxed">
